...
cat("Proporción de NAs en el conjunto de validación con 20% de reemplazo:", mean(is.na(val_data_50)), "\n")
cat("Proporción de NAs en el conjunto de testeo con 20% de reemplazo:", mean(is.na(test_data_75)), "\n")
```
